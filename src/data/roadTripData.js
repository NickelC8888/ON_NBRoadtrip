      ...
      stops: [
        {
          ...
          coords: [43.8828, -79.4403],
          night: null,
          description: 'Leave by 6–7am to beat Toronto rush hour on Hwy 401 East.',
        },
        {
          name: 'Quebec City, QC',
          coords: [46.8139, -71.2080],
          ...
          description: 'Two-night base in the only walled city north of Mexico. Walk to Petit-Champlain, the Citadelle, and the Plains of Abraham.',
        },
        {
          name: 'Fredericton, NB',
          coords: [45.9636, -66.6431],
          ...
          description: 'Two-night base in NB\'s compact capital. Riverfront trails, Beaverbrook Gallery, and excellent local food.',
        },
        {
          name: 'St. Martins, NB',
          coords: [45.3567, -65.5231],
          night: 5,
          driveFromPrevious: { distance: '90 km', time: '~1.5 hrs' },
          description: 'One night on the Fundy coast. Sea caves and covered bridges at low tide, Fundy Trail Parkway coastal drive.',
        },
        {
          name: 'Alma, NB',
          coords: [45.5997, -64.9472],
          night: 6,
          driveFromPrevious: { distance: '95 km via Hopewell Rocks', time: '~2.5 hrs with Hopewell stop' },
          description: 'Gateway to Fundy National Park. Stop at Hopewell Rocks en route (plan for low tide). Kelly\'s sticky buns and Alma Lobster Shop are Fundy institutions.',
        },
        {
          name: 'Moncton, NB',
          coords: [46.0878, -64.7782],
          night: 7,
          driveFromPrevious: { distance: '150 km', time: '~1.5 hrs' },
          description: 'Magnetic Hill optical illusion, Tidal Bore Park on the Petitcodiac, Crystal Palace for kids.',
        },
        {
          ...
          night: 8,
          driveFromPrevious: { distance: '230 km', time: '~2.5 hrs' },
          description: 'Final Maritime night. Best whale watching in eastern Canada. Book Jolly Breeze or Cruisin\' With the Whales well in advance.',
        },
        {
          name: 'Richmond Hill',
          coords: [43.8828, -79.4403],
          night: null,
          driveFromPrevious: { distance: '1,200 km', time: '~13 hrs (split strongly recommended)' },
          description: 'Long return. Strongly consider splitting over two days — overnight Edmundston or Quebec City puts you within 9–10 hrs of home.',
        },
      ],
      itinerary: [
        {
          day: 1,
          title: 'Richmond Hill → Quebec City',
          desc: 'Big drive day — ~8 hrs, ~790 km via Hwy 401 E then Autoroute 20 E. Leave by 6–7am. Rest stop at Kingston waterfront (~2.5 hrs in). Optional detour to Montmorency Falls just east of Quebec City — taller than Niagara, dog-friendly boardwalk. Arrive and stroll Petit-Champlain for dinner.',
          driveSegments: [
            {
              from: 'Richmond Hill',
              to: 'Kingston',
        ...
        },
        {
          ...
          desc: 'No driving. Morning: Citadelle guided tour and Changing of the Guard at 10am (book online). Afternoon: Museum of Civilization (outstanding kids\' section), then Quartier Petit-Champlain cobblestone shopping. Late afternoon: Plains of Abraham — huge dog-friendly park with St. Lawrence views.',
        ...
        },
        {
          day: 3,
          title: 'Quebec City → Fredericton',
          desc: '~5 hrs via Rivière-du-Loup — stop for the free waterfall right in town and lunch on the St. Lawrence promenade. Continue Route 185 S into NB via Edmundston, then Trans-Canada west to Fredericton. Arrive for an evening walk along the Saint John River.',
          driveSegments: [
            {
              from: 'Quebec City',
              to: 'Rivière-du-Loup',
        ...
        {
          day: 5,
          title: 'Fredericton → St. Martins Sea Caves + Fundy Trail',
          desc: '~90 min drive to St. Martins. Walk enormous sea caves carved by the world\'s highest tides — tide schedule must be checked the night before. Two historic covered bridges in the village for photos. Drive the Fundy Trail Parkway (16 km coastal cliff road, suspension footbridge, Long Beach tidepools, dogs on leash welcome).',
          driveSegments: [
            {
              from: 'Fredericton',
              to: 'St. Martins',
              distance: '~90 km',
              time: '~1.5 hrs',
              note: 'Hwy 1 E toward Sussex then Route 111 S to the coast. Arrive within 2 hrs of low tide for sea cave access.',
            },
          ],
          highlights: ['St. Martins Sea Caves (low tide only!)', 'Two covered bridges photo stop', 'Fundy Trail Parkway coastal drive', 'Long Beach suspension footbridge'],
          userNotes: 'Check Bay of Fundy tide times at tides.gc.ca or bayoffundy.com the night before. Sea caves require low tide — plan your Fredericton departure around this.',
        },
        {
          day: 6,
          title: 'St. Martins → Hopewell Rocks → Alma',
          desc: 'Drive ~1.5 hrs to Hopewell Rocks — trip showstopper. Walk on the ocean floor among the famous "flower pot" formations at low tide (the #1 planning priority of this entire trip). Family day pass ~$39. Then ~45 min to Alma for Kelly\'s sticky buns and Alma Lobster Shop. Fundy National Park entrance 10 min from the village.',
          driveSegments: [
            {
              from: 'St. Martins',
              to: 'Hopewell Rocks',
              distance: '~85 km',
              time: '~1.5 hrs',
              note: 'Route 111 E then 114 N to Hopewell Cape. Time your arrival for low tide — the entire detour is planned around this.',
            },
            {
              from: 'Hopewell Rocks',
              to: 'Alma',
              distance: '~45 km',
              time: '~45 min',
              note: 'Continue on Route 114 W into Fundy National Park and Alma village.',
            },
          ],
          highlights: ['Hopewell Rocks ocean floor walk', 'Fundy National Park entrance', 'Kelly\'s sticky buns (legendary)', 'Alma Lobster Shop'],
          userNotes: 'Hopewell Rocks: check tide times at pc.gc.ca. Plan 2–3 hrs minimum. Dogs on leash welcome on the beach. Cafeteria and interpretive centre on-site.',
        },
        {
          day: 7,
          title: 'Alma → Moncton',
          desc: '~1.5 hrs. Optional morning: Dickson Falls trail in Fundy NP (1.5 km boardwalk loop, spectacular with kids). Drive to Moncton for Magnetic Hill — your car rolls uphill (optical illusion). Tidal Bore Park on the Petitcodiac River twice daily (check boretime.ca). Crystal Palace indoor amusement park if rain or kids need a break.',
          driveSegments: [
            {
              from: 'Alma',
              to: 'Moncton',
              distance: '~150 km',
              time: '~1.5 hrs',
              note: 'Route 114 N through the park, then Trans-Canada east. Easy scenic drive.',
            },
          ],
          highlights: ['Dickson Falls morning hike (optional)', 'Magnetic Hill optical illusion', 'Tidal Bore Park', 'Crystal Palace (rainy day option)'],
        },
        {
          day: 8,
          title: 'Moncton → St. Andrews by-the-Sea',
          desc: '~2.5 hrs to Canada\'s oldest seaside resort town. Afternoon whale watching on Passamaquoddy Bay — Jolly Breeze Tall Ship for kids (pirate dress-up, face painting, touch tank, molasses cookies) or Cruisin\' With the Whales (marine biologist crew, 5.0 stars). Kingsbrae Garden (27 acres, alpacas, peacocks, dog-friendly). Walk Victorian Water Street for dinner.',
          driveSegments: [
            {
              from: 'Moncton',
              to: 'St. Andrews',
              distance: '~230 km',
              time: '~2.5 hrs',
              note: 'Trans-Canada Hwy 1 W to Sussex, Hwy 1 to St. Stephen, south on Hwy 127 to St. Andrews.',
            },
          ],
          highlights: ['Whale watching Passamaquoddy Bay', 'Jolly Breeze pirate ship (kids love it)', 'Kingsbrae Garden (alpacas + peacocks)', 'Water Street Victorian main street'],
          userNotes: 'Book whale watching at least 2 weeks ahead for peak season. Jolly Breeze suits younger kids best; Cruisin\' With the Whales is more educational and great for older kids and adults.',
        },
        {
          day: 9,
          title: 'St. Andrews → Home (split into Day 9 + 10 strongly recommended)',
          desc: 'Direct drive is 13+ hrs — brutal with kids and a dog. Strongly recommended: overnight in Edmundston, NB (~4.5 hrs from St. Andrews) then 9 hrs home next day. Or push to Quebec City (~6 hrs) for a scenic return overnight. En route: Hartland Covered Bridge detour (world\'s longest covered bridge, 391m, free, 20 min off Trans-Canada near Hartland, NB).',
          driveSegments: [
            {
              from: 'St. Andrews',
              to: 'Edmundston or Rivière-du-Loup',
              distance: '~350–450 km',
              time: '~4.5–5 hrs',
              note: 'Hwy 1 E to Fredericton, Trans-Canada north. Hartland Covered Bridge detour near Hartland adds only 20 min.',
            },
            {
              from: 'Edmundston / Rivière-du-Loup',
              to: 'Richmond Hill',
              distance: '~900–1,000 km',
              time: '~9–10 hrs',
              note: 'Autoroute 20 W through Montreal, Hwy 401 W. Leave early.',
            },
          ],
          highlights: ['Hartland Covered Bridge — world\'s longest (391m, free)', 'Montmorency Falls return option', 'Kingston final rest stop'],
          userNotes: 'Edmundston, NB is the practical split point — 4.5 hrs from St. Andrews, 9 hrs from Richmond Hill. Quebec City overnight is more rewarding if you want a final night in Old Town.',
        },
      ],
    },
    ...
    lodging: [
      {
        ...
        type: 'Hotel',
        location: 'Quebec City (Old Upper Town)',
        address: '1 Rue des Carrières, Québec, QC G1R 4P5',
        day: 1,
        phone: '',
        petPolicy: 'Pet-friendly — confirm size/weight limits and fee when booking',
        familySuitable: true,
        priceRange: '$$$$',
        rooms: 'Castle hotel with river views, various categories',
        bookingNote: 'The most iconic hotel in Canada. Kids will never forget staying in a castle. Book 2–3 months ahead for summer.',
      },
      {
        name: 'Best Western Premier Hôtel Aristocrate',
        type: 'Hotel',
        location: 'Quebec City (near Old City)',
        address: '3100 Chemin Saint-Louis, Québec, QC G1W 1R8',
        day: 1,
        phone: '',
        petPolicy: 'Pet-friendly — confirm at booking',
        familySuitable: true,
        priceRange: '$$',
        rooms: 'Standard and suite options, breakfast included. 4.4 stars.',
        bookingNote: '10 min drive from Old Quebec. Good value with on-site breakfast. Pet-friendly confirmed.',
      },
      {
        name: 'Ramada by Wyndham Fredericton',
        type: 'Hotel',
        location: 'Fredericton, NB',
        address: '480 Riverside Dr, Fredericton, NB E3A 8B1',
        day: 3,
        phone: '',
        petPolicy: 'Pet-friendly rooms available — confirm when booking',
        familySuitable: true,
        priceRange: '$$',
        rooms: 'Riverside setting, pool, on-site restaurant, fish pond',
        bookingNote: 'Best location for families — riverside deck is great for dogs. 3.6 stars. Check pet room availability.',
      },
      {
        name: 'Days Inn by Wyndham Fredericton',
        type: 'Hotel',
        location: 'Fredericton, NB',
        address: '958 Prospect St, Fredericton, NB E3B 3C5',
        day: 3,
        phone: '',
        petPolicy: 'Pet-friendly',
        familySuitable: true,
        priceRange: '$',
        rooms: 'Heated pool, sauna, gym, breakfast included. 3.4 stars.',
        bookingNote: 'Value pick near downtown. Pool is a great bonus for kids.',
      },
      {
        name: 'Fundy Footprints B&B',
        type: 'B&B',
        location: 'St. Martins, NB',
        address: '4 Snows Lane, St. Martins, NB E5R 1C8',
        day: 5,
        phone: '',
        petPolicy: 'Dog bed and toy provided in-room — one of the best dog-friendly stays in NB',
        familySuitable: true,
        priceRange: '$$$',
        rooms: 'Newly renovated with ocean views and beach access. 4.9 stars.',
        bookingNote: 'Dog bed and toy waiting in your room. Beach access on-site. Book early — fills fast.',
      },
      {
        name: 'Fundy Woods Campground & Cottages',
        type: 'Cottage',
        location: 'St. Martins, NB',
        address: '2644 NB-111, St. Martins, NB E5R 1E2',
        day: 5,
        phone: '',
        petPolicy: 'Pet-friendly throughout',
        familySuitable: true,
        priceRange: '$$',
        rooms: 'Cottages and campsites with Bay of Fundy views. 4.8 stars.',
        bookingNote: 'On-site hiking trails. Great for outdoorsy families.',
      },
      {
        name: 'Alma Shore Lane Suites & Cottages',
        type: 'Cottage',
        location: 'Alma, NB',
        address: '24 Foster Rd, Alma, NB E4H 1N1',
        day: 6,
        phone: '',
        petPolicy: 'Ask about pet policy when booking',
        familySuitable: true,
        priceRange: '$$$',
        rooms: 'Suites with fireplace, kitchenette, ocean views, steps from beach. 4.6 stars.',
        bookingNote: 'Excellent host communication. Steps from the tidal beach.',
      },
      {
        name: 'Alpine Motor Inn',
        type: 'Motel',
        location: 'Alma, NB',
        address: '8591 Main St, Alma, NB E4H 1N4',
        day: 6,
        phone: '',
        petPolicy: 'Pet-friendly — confirm when booking',
        familySuitable: true,
        priceRange: '$',
        rooms: 'Rooms facing Muskoka chairs on the Bay of Fundy tidal flat. 4.2 stars.',
        bookingNote: 'Unbeatable location right on the bay. Walking distance to Kelly\'s and Alma Lobster Shop.',
      },
      {
        name: 'Quality Inn Moncton',
        type: 'Hotel',
        location: 'Moncton, NB',
        address: '2530 Mountain Rd, Moncton, NB E1G 2B7',
        day: 7,
        phone: '',
        petPolicy: 'Pet-friendly',
        familySuitable: true,
        priceRange: '$$',
        rooms: 'Pool, comfortable rooms, near Magnetic Hill. 4.0 stars.',
        bookingNote: 'Solid mid-range option. Staff highly praised. Good base for Magnetic Hill and Tidal Bore.',
      },
      {
        name: 'Crowne Plaza Moncton Downtown',
        type: 'Hotel',
        location: 'Moncton, NB (Downtown)',
        address: '1005 Main St, Moncton, NB E1C 1G9',
        day: 7,
        phone: '',
        petPolicy: 'Confirm at booking',
        familySuitable: true,
        priceRange: '$$$',
        rooms: 'Indoor pool, adjacent to Crystal Palace amusement park via interior corridor.',
        bookingNote: 'Best if kids want Crystal Palace access. Ask about pet policy directly.',
      },
      {
        name: 'Woodhaven Country Lodge',
        type: 'Lodge',
        location: 'Oak Bay, NB (10 min from St. Andrews)',
        address: '14 Murray Lane, Oak Bay, NB E5B 3L7',
        day: 8,
        phone: '',
        petPolicy: 'Dog paradise — gated dog areas, hot tub with ocean views, private beach access',
        familySuitable: true,
        priceRange: '$$$',
        rooms: 'Lodge rooms and cottages, private beach. 4.9 stars.',
        bookingNote: 'Best dog-friendly stay on the entire route. Book months in advance for summer.',
      },
      {
        ...
        bookingNote: 'A special final-night splurge. Beautiful grounds and right in the heart of St. Andrews.',
      },
    ],
